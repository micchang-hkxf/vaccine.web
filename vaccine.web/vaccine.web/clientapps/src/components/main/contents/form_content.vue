        ...
        <template v-slot:app-content>
            ...
            <com-dialog ref="viewer" ref-key="two" width="60%">
                ...
                <template v-slot:content>
                    ...
                    <v-divider></v-divider>
                    {{result.model}}///{{result.model.regist_type.name}}
                    <div>
                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>接種類型</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_type.name}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>
                        <v-list-item two-line>
                            <v-list-item-content>
                        ...
                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>場次標題</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_title}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>

                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>設站行政區</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_district.name}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>

                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>設站村里</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_village.name}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>

                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>設站地點</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_place}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>

                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>醫療院所</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_institution.name}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>

                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>機構代碼</v-list-item-subtitle>
                        ...
                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>機構所在行政區</v-list-item-subtitle>
                                <v-list-item-title></v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>
                        ...
                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>設站時間</v-list-item-subtitle>
                                <v-list-item-title>
                        ...
                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>事先開放報名時間</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_in_advance}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>
                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>接種資格複審時間</v-list-item-subtitle>
                                <v-list-item-title></v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>
                        <v-divider></v-divider>
                        ...
                        <v-list-item two-line>
                            <v-list-item-content>
                                <v-list-item-subtitle>接種資格複審時間</v-list-item-subtitle>
                                <v-list-item-title>{{result.model.regist_quota}}</v-list-item-title>
                            </v-list-item-content>
                        </v-list-item>
