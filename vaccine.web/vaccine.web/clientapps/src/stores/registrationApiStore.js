...
export default {
    ...
    state: {
        ...
        headers: [
            ...
            { text: '場次標題', value: 'regist_title', align: 'left',sortable: false, flex: 6 },
            ...
            { text: '行政區', value: 'regist_district_name', align: 'center', sortable: false, flex: 6},
            { text: '村里', value: 'regist_village_name', align: 'center', sortable: false, flex: 6, width: '80' },
            ...
            { text: '名額', value: 'regist_quota', align: 'right',sortable: false, flex: 6 },
        ...
        institutions: [],
        registrationHeaders: [
            { text: '報名日期', value: 'date', align: 'center', sortable: true, flex: 6 },
            { text: '姓名', value: 'name', align: 'center', sortable: false, flex: 6 },
            { text: '序號', value: 'serialNumber', align: 'center', sortable: false, flex: 6 },
            { text: '性別', value: 'gender', align: 'center', sortable: false, flex: 6 },
